 ...
 *
 * This is a widget for the Inhabitent theme to create widget to set and display business hours.
 *
 * Lightly forked from the WordPress Widget Boilerplate by @tommcfarlin.
 *
 * @package   Inhabitent Business Hours Widget
 * @author     Wes deLange<wes.delange@gmail.com>
 * @license   GPL-2.0+
 ...
 * Description:       This is a widget for the Inhabitent theme to set and display business hours.
 * Version:           1.0.0
 * Author:            Wes deLange
